...
app.service('orderService',function($http){
	...
	//查询订单统计
	this.findOrderService = function (sellerName,startTime,endTime) {
		return $http.post('../order/findOrderService.do?sellerName='+sellerName+'&startTime='+startTime+'&endTime='+endTime);
    };

    //搜索指定商家的所有订单id
    this.findAllByUserId = function (pageNum,pageSize,order) {
