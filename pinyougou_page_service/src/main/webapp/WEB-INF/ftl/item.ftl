                ...
                <div class="clearfix choose">
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${option}') ? 'selected' : ''}}" ng-click="selectSpecification('${spec.attributeName}','${option}')">${option}<span title="点击取消选择">&nbsp;</span></a></dd>
                            </#list>
                        </dl>
                        </#list>
                    </div>
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:;" ng-click="addToCart()"  class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
